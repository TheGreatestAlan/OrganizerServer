...
public class KeepApi {
  ...
  private static final String CREDENTIALS_FILE_PATH = "/Users/en2542/Downloads/local/OrganizerServer/organizerserver/dev/domainWideDelegation";
  ...
  private static Credential getOAuthCredentials(final NetHttpTransport HTTP_TRANSPORT)
      throws IOException {
    // Load client secrets.
    InputStream in = KeepApi.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
    if (in == null) {
